...
使用：
  python3 memory_system/scripts/check_quality.py                # 检查所有 session 日志
  python3 memory_system/scripts/check_quality.py --file memory/2026-06-08.md  # 检查单个
  python3 memory_system/scripts/check_quality.py --strict       # quality<0.5 退出非零
