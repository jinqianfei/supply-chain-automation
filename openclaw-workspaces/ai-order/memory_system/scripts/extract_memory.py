...
使用：
  python3 memory_system/scripts/extract_memory.py          # 生成摘要到 stdout
  python3 memory_system/scripts/extract_memory.py --apply  # 替换 MEMORY.md 的会话摘要段
  python3 memory_system/scripts/extract_memory.py --days 14  # 改窗口（默认 7）
