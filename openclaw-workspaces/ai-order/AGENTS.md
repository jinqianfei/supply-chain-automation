...
## ⚠️ 当前活跃Skill版本：v5.15.2（唯一版本）

### skill_order_to_huading_template v5.15.2
**路径**: `skills/skill_order_to_huading_template/`

**版本标识**: v5.15.2（2026-06-12）—— 所有订单处理都使用此版本，不再使用旧版本。
