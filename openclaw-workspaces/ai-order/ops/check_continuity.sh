...
#
# 用法：
#   bash ops/check_continuity.sh
#   bash ops/check_continuity.sh --warn-hours 24  # 自定义警告阈值
#   bash ops/check_continuity.sh --p0-hours 72    # 自定义 P0 阈值
#   bash ops/check_continuity.sh --no-feishu      # 不发飞书告警
