...
功能：
1. 加载 learning/config/notification_config.yaml
2. 根据 approval_type 找到接收人
3. 根据 channel 调用对应的发送函数（飞书/钉钉）

用法：
    python3 learning/scripts/notification_sender.py <approval_type> <message>

示例：
    python3 learning/scripts/notification_sender.py alias_expansion "别名表改进建议..."
"""
import os
import sys
import yaml
...
def load_config() -> Dict:
    """加载通知配置（支持环境变量展开）"""
    config_path = os.path.join(_WORKSPACE, "learning", "config", "notification_config.yaml")
